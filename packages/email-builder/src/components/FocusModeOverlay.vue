...
<template>
	...
	>
		<div
			v-if="isFocusMode"
			class="fixed top-4 left-4 z-[10050] flex items-center gap-2 py-2 px-3.5 rounded-[10px] bg-bg-elevated/85 backdrop-blur-overlay border border-border-subtle opacity-50 transition-[opacity,box-shadow] duration-200 hover:opacity-100 hover:shadow-[0_2px_8px_rgba(0,0,0,0.08)]"
		>
			<div
				class="w-2 h-2 rounded-full bg-green-500 transition-[background-color] duration-200"
	...
	>
		<button
			v-if="isFocusMode"
			class="fixed top-4 right-4 z-[10050] p-2.5 rounded-[10px] bg-bg-elevated/85 backdrop-blur-overlay border border-border-subtle text-text-secondary cursor-pointer opacity-30 transition-all duration-200 hover:opacity-100 hover:text-text-primary hover:bg-bg-elevated/95 hover:scale-105 active:scale-95"
