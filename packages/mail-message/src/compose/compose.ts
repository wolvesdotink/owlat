 ...
 * (node:crypto + @owlat/mail-canon only, pinned by
 * scripts/check-cross-package-imports.sh). The `URL` constructor runs the same UAX-46 ToASCII the browser does and exposes
