...
<template>
	...
	>
		...
		<div
			...
			style="top: 10%; left: 50%; transform: translateX(-50%); width: 800px; height: 600px; border-radius: 50%; background: radial-gradient(ellipse 60% 50%, rgba(196, 120, 90, 0.05) 0%, transparent 70%)"
			aria-hidden="true"
		/>
		...
		<div class="max-w-[1200px] mx-auto px-8 max-md:px-6 relative">
			...
			<div class="oss-el max-w-[520px] mx-auto mb-16 max-md:mb-12" style="--i: 3">
				<div
					class="terminal-window border border-border-default rounded-2xl overflow-hidden transition-all duration-400"
			...
			<div class="grid grid-cols-4 gap-3 max-lg:grid-cols-2 max-md:grid-cols-1">
				...
				>
					<!-- Icon -->
					<div class="w-9 h-9 rounded-lg flex items-center justify-center mb-4 transition-transform duration-250 group-hover:scale-105" style="background: var(--color-brand-soft)">
						<!-- Eye -->
					...
					<h3 class="text-[0.9375rem] font-semibold text-text-primary mb-1.5 leading-[1.3] transition-colors duration-300 group-hover:text-brand">
						{{ benefit.title }}
					</h3>
			...
			<div class="oss-el text-center mt-12" style="--i: 8">
				<a
					...
					class="gh-link group inline-flex items-center gap-2.5 px-6 py-3 text-sm font-semibold text-text-primary bg-transparent border border-border-default rounded-xl no-underline transition-all duration-250 hover:border-brand/40 hover:text-brand hover:-translate-y-px hover:bg-brand-soft btn-press relative"
				>
					<!-- GitHub icon -->
					<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" class="transition-transform duration-250 group-hover:scale-110">
					...
					<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="transition-transform duration-250 group-hover:translate-x-[2px] group-hover:-translate-y-[2px]">
