...
Fired on first open, tracked via a 1×1 pixel beacon. Pixel fetches by Apple Mail Privacy Protection and security scanners are not opens and do not fire this event.
...
Fired on each link click, via the tracked-URL redirect. Links followed by security gateways and link scanners are not clicks and do not fire this event; the scanner is still redirected.
