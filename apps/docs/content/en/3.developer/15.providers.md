...
anything the provider reports back other than the pinned version or one of its
aliases comes back uncalibrated, which puts every threshold downstream to sleep
