...
| `EMAIL_PROVIDER` | Convex | `mta`, `ses`, `resend`, `smtp`, `mandrill`, or `emailit` — no implicit default; unset means unconfigured and sends are refused |
...
└── packages/
    ├── email-builder/      # Vue email editor + preview components
