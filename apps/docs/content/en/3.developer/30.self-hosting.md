...
| Requirement | Minimum |
| --- | --- |
| CPU architecture | x86_64 (amd64) or aarch64 (arm64) — e.g. Hetzner CAX, Oracle Ampere, AWS Graviton |
| Docker | 20.10+ |
...
| Reverse DNS (PTR) control on the sending IP | Required for the built-in MTA — set the PTR to your EHLO hostname in your hosting provider's console. Setup will not finish without it. |
