...
::callout{type="info"}
Automation emails are sent without open/click tracking and without an unsubscribe footer, and they only reach contacts that have an email address. Contacts added through SMS, WhatsApp, or phone with no email will fail the **Send Email** step (logged as a failure for that contact). A contact who unsubscribed from all marketing gets no more automation emails: their **Send Email** steps are skipped and the rest of the automation (delays, conditions, integrations) carries on. Deleting a contact ends its automation runs.
::
