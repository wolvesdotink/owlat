...
Eine Ausnahme: Eine Anfrage an einen vorhandenen Pfad mit einer nicht
unterstützten Methode antwortet mit `405` und trägt `invalid_input`. Der Status
stammt vom Transport, nicht von der Kategorie — bei allen anderen Antworten ist
er der oben genannte.
