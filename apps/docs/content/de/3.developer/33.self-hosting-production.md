...
# Allow IMAPS — nur mit der Funktion personal-mail, für Mail-Clients
...
- **25, 465 und 587** sind bei den meisten VPS-Produkten standardmäßig gesperrt.
  [Versand von einem VPS](/guide/sending-from-a-vps) führt die Politik und den
  Freischaltweg der großen Anbieter auf. Ein offenes 587 heißt nicht, dass 25
  offen ist.
...
**Administration → System & Updates → Netzwerk-Ports** prüft jeden Port aus
beiden Tabellen vom Server aus und zeigt, welcher offen ist, welcher gesperrt
ist und welche Funktion daran hängt. Die Prüfungen laufen nur auf Knopfdruck:
Jede öffnet eine Verbindung zu einem bekannten Host und schließt sie sofort
wieder, ohne etwas zu senden.
::
