...
| Anforderung | Minimum |
| --- | --- |
| CPU-Architektur | x86_64 (amd64) oder aarch64 (arm64) — z. B. Hetzner CAX, Oracle Ampere, AWS Graviton |
| Docker | 20.10+ |
...
| Reverse-DNS-(PTR-)Kontrolle für die Versand-IP | Für die eingebaute MTA erforderlich — den PTR in der Konsole Ihres Hosters auf Ihren EHLO-Hostnamen setzen. Ohne ihn schließt das Setup nicht ab. |
