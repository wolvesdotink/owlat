...
Ein Teil des Keyspace ist von Natur aus dauerhaft und schrumpft nie von selbst: die Suppression-Liste. Ein Hard Bounce oder eine Spam-Beschwerde darf nicht ablaufen, deshalb kostet jede unterdrückte Adresse für die gesamte Lebensdauer der Installation rund 300 Byte — etwa 30 MB je 100.000 Adressen und bei einer Million mehr als die Hälfte einer 512-MB-Grenze. Rechnen Sie diesen Sockel heraus, bevor Sie auf ein Leck schließen: Eine lang laufende Instanz mit großer Suppression-Liste trägt schlicht die Liste, die sie tragen soll. Erhöhen Sie `REDIS_MAXMEMORY`, wenn Ihre in die Hunderttausende geht. Die Adressen liegen zusätzlich dauerhaft in der Blockliste von Owlat; diese Kopie ist also eine Absicherung und nicht der maßgebliche Datensatz.
