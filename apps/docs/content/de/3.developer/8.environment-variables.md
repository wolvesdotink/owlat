...
Zwei voneinander unabhängige Obergrenzen für das Redis, das sich MTA und IMAP-Auth-Bremse teilen. Die Standardwerte passen zu einer kleinen Single-Box-Installation (4-8 GB RAM) und lassen reichlich Luft: ein gesunder Owlat-Keyspace ist einige zehn Megabyte groß, 512 MB zu erreichen bedeutet also ein Leck und nicht, dass Sie den Standardwerten entwachsen sind. Erhöhen Sie beide gemeinsam, wenn Sie tatsächlich hohes Volumen fahren.
