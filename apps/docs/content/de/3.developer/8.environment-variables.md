...
Das ist **optional und ergänzend**. App-Passwörter funktionieren weiterhin bei jedem Anbieter, auch bei Gmail: Ist kein OAuth-Client konfiguriert, zeigt die Gmail-Karte unverändert das App-Passwort-Formular; ist einer konfiguriert, bietet sie „Mit Google fortfahren“ als empfohlenen Weg und daneben „Stattdessen App-Passwort verwenden“.

| Variable | Beschreibung |
| --- | --- |
| `GOOGLE_OAUTH_CLIENT_ID` | Client-ID des Google-OAuth-Clients. Nicht gesetzt ⇒ die Google-Anmeldung wird nicht angeboten, die Gmail-Karte fällt auf das App-Passwort-Formular zurück. |
