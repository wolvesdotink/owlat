...
Diese Liste ist die letzte Absicherung vor dem Versand, nicht der maßgebliche Datensatz: Die Blockliste von Owlat ist die Quelle der Wahrheit, und jeder dort ergänzte Bounce, jede Beschwerde und jede manuelle Sperre wird hierher gespiegelt (eine `unengaged`-Sunset-Sperre nicht — sie darf transaktionale Mail nicht blockieren). Das Entfernen einer gespiegelten Sperre in der App entfernt auch ihre MTA-Kopie. Ein täglicher Abgleich baut nach vorübergehenden Fehlern fehlende Einträge neu auf und entfernt reine Redis-Waisen, einschließlich Einträgen aus dem früheren Ablaufverhalten.
