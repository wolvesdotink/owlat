...
| `externalAccounts.ts` / `externalAccountsActions.ts` / `externalDelivery.ts` | Verbinden/Testen/Synchronisieren externer Postfächer (siehe [Externe Postfächer](#external-mailboxes-mailexternal)) |
