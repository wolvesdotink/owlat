...
last-used mode is saved to your account. Opening a message, any other folder,
and search all use the regular three-pane UI — every row, shortcut, and
action in Today is the same as in Browse.
