...
- **What's stored:** the folder list, the newest ~200 inbox rows, and the sanitized bodies of the ~50 most recently read messages. Only the already-sanitized version of each message is cached — never the raw mail.
...
Not yet cached in this version: offline sending/queued actions, full-mailbox sync, and encryption at rest. Those are planned follow-ups.
