...
Closing the main window **quits** the app — there is no menu-bar tray icon. Reopen Owlat from your Applications folder (or the taskbar / launcher), or bring it to the front any time with the global show/hide shortcut.
