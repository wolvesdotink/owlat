...
| `EMAIL_PROVIDER` | Email provider: `mta`, `ses`, `resend`, `smtp`, or `mandrill`. No implicit default — leave it unset and sends are refused rather than routed to the built-in MTA. |
