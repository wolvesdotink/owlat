...
| `examples/plugins/deliverability-lab` | Tier-3 reference plugin: pre-send deliverability checks (spam score, link and accessibility audit, seed-list test) run in the sandboxed worker behind a restrict-only send gate |
