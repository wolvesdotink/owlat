...
2. **Two** of the send producers put that value on the durable send **envelope** at enqueue time, and the value is normalised there (at the DB read) so nothing degenerate can enter a durable envelope:
