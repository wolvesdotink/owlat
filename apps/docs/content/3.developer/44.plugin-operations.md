...
The same container actively serves the coding-agent queue under the `inbox-codetasks` profile. See [Sandboxed Jobs](/developer/plugin-sandboxed-jobs) for the reserved Tier-3 contract.
