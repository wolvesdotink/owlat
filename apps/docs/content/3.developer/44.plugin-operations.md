...
| --- | --- | --- |
| Stop a bundled plugin now | Disable its feature flag | Next operation |
| Withdraw a bundled plugin's authority | Disable the flag (this deletes its grants) | Next operation |
