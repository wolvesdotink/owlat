...
Every catalog entry answers seven capability questions, and the rest of the system asks the catalog rather than naming a kind:
...
Four consequences worth naming, because they used to be hard-coded identity checks:
