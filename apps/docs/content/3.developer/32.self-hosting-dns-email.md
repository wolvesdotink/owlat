...
- [DigitalOcean IPv6](https://docs.digitalocean.com/products/networking/ipv6/how-to/enable/)
  ...
  IPv6 address.
- [OVHcloud reverse DNS](https://help.ovhcloud.com/csm/asia-public-cloud-compute-configure-reverse-dns?id=kb_article_view&sysparm_article=KB0038924)
  is under Network → Public IP Addresses → Configure reverse DNS. Confirm your
  product exposes the chosen IPv6 there; otherwise ask OVHcloud about reverse
  zone delegation before adding it to a pool.
