...
const knownStructureDrift = {
	...
	'3.developer/8.environment-variables.md': {
		en: {
			headings: '233333111111131131131111111111431111111343333322334343334434323323332331222223333',
			fences: [
				'sh',
				'plain',
				'sh',
		...
		de: {
			headings: '23333311111113113113111111111143111111134333322334343334434323323332331222223333',
			fences: [
				'sh',
				'plain',
				'sh',
