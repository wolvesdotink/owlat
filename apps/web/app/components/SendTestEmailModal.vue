	...
	>
		...
		<div class="space-y-6">
			<!-- No verified domain warning -->
						<div
							v-if="noVerifiedDomain"
							class="flex items-start gap-3 p-4 bg-warning-subtle rounded-lg"
						>
							...
							<div>
								...
								<p class="text-sm text-text-secondary mt-1">
									You need to verify a domain before sending test emails. Go to Settings &gt;
									Domains to add and verify your domain.
								</p>
							</div>
						</div>
						...
						<Transition name="fade">
							...
							>
								...
								<p
									class="text-sm"
									:class="sendResult.success ? 'text-success' : 'text-error'"
								>
									{{ sendResult.message }}
								</p>
							</div>
