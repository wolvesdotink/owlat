...
// A contenteditable div is not labelable and its "placeholder" is a sibling
// <div>: nothing names the textbox unless this does. A caller's placeholder
// ("Your signature…") names it better than the fallback, so it wins.
