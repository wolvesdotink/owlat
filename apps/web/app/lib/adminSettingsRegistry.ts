...
export const ADMIN_REGISTRY: readonly AdminEntry[] = [
	...
	{
		// The one page that decides drafting and sending on its own.
		id: 'aiReplies',
		path: `${ADMIN_ROOT}/instance/ai-replies`,
		titleKey: label('aiReplies'),
		icon: 'lucide:bot',
		area: 'ai',
		gate: anyFlag('ai.agent', 'ai.autonomy'),
	},
	{
		// The two pages AI replies replaced. They forward into it, and keep their
		// old names so the palette still finds "agent" and "autonomy".
		id: 'agent',
