/**
 * Catalog keys whose German message is legitimately identical to the English
 * one: proper nouns (Mailchimp, Twilio, OpenAI), terms German borrows wholesale
 * (Spam, Marketing, Chat, Port), IANA timezone or language names, or a
 * placeholder that is the same in both. Consumed by localeCatalogs.test.ts,
 * which also fails on any entry here that no longer excuses a live key.
 */
export const INTENTIONALLY_IDENTICAL_KEYS: readonly string[] = [
	'accessRequest.brand',
	...
	'dashboard.admin.team.api.index.pageTitle',
	'dashboard.admin.team.api.index.rateLimit.headerColumn',
	'dashboard.admin.team.api.index.title',
	'dashboard.admin.team.pageTitle',
	'dashboard.admin.team.title',
	...
	'dashboard.inbox.activity.channels.generic',
	...
	'dashboard.inbox.updates.tabs.spam',
	...
	'dashboard.send.index.filters.marketing',
	'dashboard.send.index.templateTypes.marketing',
	...
	'shared.breadcrumbRoutes.pages.api',
	...
	'shared.dashboardNavigation.items.administration.teamAccess',
	...
	'shared.postbox.usePostboxThreadCategories.options.spam',
	...
	'shell.admin.areas.system',
	'shell.admin.areas.team',
