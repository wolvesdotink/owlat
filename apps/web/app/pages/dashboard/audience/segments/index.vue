...
const { results: segments, isLoading: segmentsLoading, status: segmentsStatus, loadMore: loadMoreSegments } = usePaginatedQuery(api.segments.list, () => ({}), { initialNumItems: 100 });
...
const {
	isSegmentModalOpen, isEditMode, segmentForm, segmentErrors, isSaving,
	matchingCount, countLoading, openCreateModal, openEditModal, closeSegmentModal, handleSave,
	isDeleteModalOpen, deleteTarget, isDeleting, openDeleteModal, closeDeleteModal, handleDelete,
} = useSegmentForm();
...
<template>
	<div class="p-6 lg:p-8">
		...
		<UiModal
			...
			:closable="!isSaving"
			:persistent="isSaving"
			@update:open="(v) => { if (!v) closeSegmentModal(); }"
		>
			<!-- Form -->
