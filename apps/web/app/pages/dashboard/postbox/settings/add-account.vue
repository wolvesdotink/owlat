	...
	<div class="p-6 lg:p-8 max-w-2xl mx-auto">
		...
		<section v-if="step === 1" class="card mt-6 p-6">
			...
			<div v-if="verifiedDomains.length === 0" class="text-text-secondary text-sm">
				...
				<NuxtLink to="/dashboard/settings/domains" class="text-brand hover:underline">
			...
			<div v-else class="space-y-4">
				...
				<div>
					<label for="displayname" class="text-sm font-medium block mb-1">Display name (optional)</label>
		...
		<section v-if="step === 4" class="card mt-6 p-6 text-center">
			...
			<p class="text-text-secondary mt-2">
				Your mailbox is connected. Make sure your domain's MX records point to this Owlat
				instance so mail starts flowing.
			</p>
			<div class="mt-6 flex items-center justify-center gap-3">
				<NuxtLink to="/dashboard/postbox/inbox" class="btn btn-primary">
					Open inbox
				</NuxtLink>
