		...
		<div class="mx-auto max-w-3xl px-6 py-12">
			...
			<header class="mb-6">
				...
				<p class="text-text-secondary leading-relaxed">
					...
					step. See
					<a href="https://docs.owlat.app/guide/operating-modes" target="_blank" rel="noopener" class="text-brand hover:text-brand-hover underline">Operating Modes</a>
					for the full matrix.
				</p>
			</header>
				...
				<li v-for="key in OPERATING_MODE_KEYS" :key="key">
					...
					>
						<div class="flex flex-wrap items-center gap-2">
							...
							<UiBadge v-if="OPERATING_MODES[key].needsDeliveryProvider" variant="warning">needs a delivery provider</UiBadge>
							<UiBadge v-else-if="OPERATING_MODES[key].needsMta" variant="neutral">needs the built-in MTA</UiBadge>
