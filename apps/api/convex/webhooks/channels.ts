/**
 * Inbound channel message ingestion — the pipeline's terminal mutation.
 *
 * `webhooks/dispatcher.ts` routes a verified `channel.received` event here;
...
import { sealBodyAtWrite, sealUnifiedMessageContentAtWrite } from '../lib/messageBody';
