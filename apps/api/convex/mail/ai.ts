...
// ── Coach my draft (high-stakes self-critique of the USER's own text) ───────

/**
 * The middle rung between "suggest a reply" and "auto-draft" for money / legal /
 * bad-news mail people will not hand to an AI: it critiques what the USER wrote
 * without ever rewriting it. Categories the flat self-check flags are bucketed
 * into for inline display next to the composer / review textarea.
 */
