...
export const alignmentTables = {
	// Dual-transport alignment pre-flight results. One row per sending
	...
	// SUPPORTED CONFIGURATION, never an error state.
	deliverabilityAlignmentStates: defineTable({
		...
		// measurement confidence is lowered, the ramp is NOT blocked.
