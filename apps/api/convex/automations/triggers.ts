...
/**
 * Generic-free trigger module shape the fanout calls. Every core trigger uses
 * this identical fanout — one running-instance guard, one no-steps guard, one
 * stats bump, one scheduled walker.
 */
