...
/**
 * Is this From-domain's SES relay identity fully, FRESHLY proven?
 *
 * Exported for the warming-cap gate, which asks the same question about the
 * same relay for a different purpose (can warm-up overflow absorb the tail?).
 * One definition of "verified" keeps the two from drifting.
 */
