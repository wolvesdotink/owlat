...
const UNREACHED_ENTRIES: readonly string[] = [
	...
	'auth/userProfiles.ts#get',
	'auth/userProfiles.ts#getByAuthUserId',
	...
	'campaigns/scheduling.ts#listStuckCampaigns',
	'chat/cleanup.ts#cleanupLegacyChatData',
	'codeWorkTasks.ts#get',
	'codeWorkTasks.ts#listByStatus',
	'codeWorkTasks.ts#markMerged',
