...
**Status:** accepted (`campaigns/lifecycle.ts`, `campaigns/abTestLifecycle.ts` and `campaigns/preflight.ts` have been in the tree since the initial commit, 2026-06-30; see Execution)
